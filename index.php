...
<head>
    ...
    <!-- Gritter -->
    <link href="/assets/lib/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<body class="skin-1">
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="https://d.hibiya.moe/OYN.png" />
                             </span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">박정현</strong>
                             </span> <span class="text-muted text-xs block">서버 관리자</span> </span> </a>
                        </div>
    ...
    <!-- GITTER -->
    <script src="/assets/lib/js/plugins/gritter/jquery.gritter.min.js"></script>
    ...
    <!-- ChartJS-->
    <script src="/assets/lib/js/plugins/chartJs/Chart.min.js"></script>
    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success('NetPro-KLP 방화벽 컨트롤 패널 연결 완료', '관리자님 환영합니다.');
